...
// Elemen selesai
let selesaiDiv = document.getElementById('level-selesai');
if (!selesaiDiv) {
    selesaiDiv = document.createElement('div');
    selesaiDiv.id = 'level-selesai';
...
if (!nextLevelBtn) {
    ...
    nextLevelBtn.textContent = 'Ke Level 2';
...
if (!retryBtn) {
    ...
    retryBtn.textContent = 'Ulangi Level 1';
...
function showQuestion() {
    ...
    if (current >= questions.length) {
        ...
        localStorage.setItem('skor_level1', score);
        ...
        if (score >= 70) {
            localStorage.setItem('level1_numerasi_selesai', 'true');
            setTimeout(() => {
...
nextLevelBtn.onclick = function () {
    window.location.href = 'level2_numerasi.html';
};
